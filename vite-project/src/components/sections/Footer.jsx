  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div
          className={`absolute top-10 right-1/3 w-120 h-48 rounded-full blur-3xl ${
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <motion.div variants={itemVariants} className="space-y-4">
              ...
              >
                <a href="https://linkedin.com/in/joshua-kipamet-148698140/">
            ...
            <motion.div variants={itemVariants} className="space-y-2">
              ...
              >
                © {new Date().getFullYear()} Joshua Kipamet · Built with React &
                Framer Motion reserved.
              </p>
