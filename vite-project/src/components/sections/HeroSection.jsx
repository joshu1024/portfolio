...
import { delay, motion, scale, useScroll, useTransform } from "framer-motion";
    ...
    >
      ...
      >
        <div className="absolute inset-0 overflow-hidden">
          ...
          />
          <motion.div
            animate={{ sclae: [1.1, 1, 1.1], rotate: [360, 180, 0] }}
          ...
          <div className="block lg:hidden ">
            ...
            >
              ...
              >
                ...
                technologies and thoughtful user experiences to help businesses
                grow.
              </motion.p>
              <motion.div
              ...
              >
                {[
                  { icon: FiGithub, href: "https://github.com/joshu1024" },
                  {
                    icon: FiLinkedin,
              ...
              <motion.div
                variants={itemVariants}
                className="flex justify-center items-center space-x-6 text-xs tracking-wider uppercase flex-wrap"
              >
                <span
                  className={`${
          ...
          <div className="hidden lg:grid lg:grid-cols-2 lg:gap-16 lg:items-center">
            ...
            >
              ...
              >
                {[
                  ...
                  {
                    icon: Mail,
                    href: "https://mail.google.com/mail/?view=cm&fs=1&to=joshuakipamet@gmail.com&su=Subject&body=BodyText",
                  },
                ].map((social, index) => (
                  <motion.a
                    key={index}
            ...
            >
              <div className="relative">
                <motion.div
                  variants={itemVariants}
                  className="flex items-center  justify-center gap-x-7 text-xs uppercase tracking-widest absolute -top-16 -left-28"
                >
                  <span
                    className={`${
                ...
                <motion.div whileHover={{ scale: 1.02 }} className={`w-80 `}>
                  <img
                    src={PROFILE_PIC}
                    alt="profile"
                    className="w-full h-full object-cover rounded-3xl border-8 border-white dark:border-gray-900 shadow-2xl "
                  />
                </motion.div>
        ...
        <motion.div
          onClick={() => {
            ...
            scrollToSection("skills"); // Change to the next section ID dynamically if needed
          }}
          animate={{ y: [0, 8, 0] }}
