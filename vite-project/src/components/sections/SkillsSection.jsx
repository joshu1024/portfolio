...
import { STATS, TECH_STACK, SKILLS_CATEGORY } from "../../utils/data.js";
    ...
    >
      ...
      <div className="max-w-6xl  mx-auto relative z-10">
        ...
        >
          ...
          >
            A comprehensive toolkit for building scalable web applications from
        ...
        >
          ...
          >
            ...
            <motion.div
              variants={itemVariants}
              className="flex flex-col flex-wrap justify-center gap-3"
            >
              {TECH_STACK.map((tech, index) => (
                <motion.span
                  key={tech}
                  whileHover={{ y: -2, scale: 1.05 }}
                  className={`px-4 text-center py-2 text-sm rounded-full border transition-all duration-300 ${
                    isDarkMode
